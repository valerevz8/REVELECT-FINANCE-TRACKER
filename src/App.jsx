...
function FinanceApp({ session, theme, onThemeChange, subInfo }) {
  ...
  return (
    <div className="fc-app" data-theme={theme}>
      ...
      {(tab === 'transactions' || tab === 'charts') && <MonthNav monthLabel={monthLabel} shiftMonth={shiftMonth} t={t} />}
      ...
      <div className="fc-body fc-body-with-nav">
        ...
        {tab === 'charts' && (
          <>
            ...
            {analyticsSubTab === 'charts' ? <Charts t={t} totals={totals} lang={lang} /> : <MonthlyReport t={t} lang={lang} rows={monthlyRows} transactions={transactions} debts={debts} />}
            <AskReviButton t={t} />
          </>
        )}
        {tab === 'review' && (
...
function Dashboard({ t, lang, totals, displayName, budgets, accounts, recurringItems, debts, monthlyRows, onViewAnalytics, onViewTransactions, onMarkPaid, onOpenDebtPay, transactions, monthTx, selectedMonth, onEditBudget }) {
  ...
  const weekByCat = {};
  weekTx.forEach(tx => { if (tx.category) weekByCat[tx.category] = (weekByCat[tx.category] || 0) + Number(tx.amount); });
            ...
            <div className="fc-section fc-section-light">
              ...
              {weekTopCatEntry && (
                <div className="fc-week-review-top">
                  {t.topCategory}: <b>{t.categories[weekTopCatEntry[0]] || weekTopCatEntry[0]}</b> — {fmtIDR(weekTopCatEntry[1])}
                </div>
              )}
            </div>
          )}
