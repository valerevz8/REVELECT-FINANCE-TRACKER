...
const CAT_COLORS = {
  ...
  rent: '#9B4A3F',         // deep brick red/burgundy — kept clearly apart from Shopping's orange
        ...
        <>
          ...
          <div className="fc-safe-hero">
            ...
            <div className="fc-safe-bar-track">
              ...
              <div className="fc-safe-bar-seg" style={{ width: `${reservedPct}%`, background: '#4f7a8a' }} />
            ...
            <div className="fc-safe-legend">
              ...
              <span><i style={{ background: '#4f7a8a' }} />{t.reservedLabel}: {fmtIDR(reservedBudget)}</span>
            </div>
          </div>
    ...
    <div className="fc-card fc-analytics-card">
      ...
      <ResponsiveContainer width="100%" height={240}>
        <ComposedChart data={data} margin={{ left: 0, right: 8, top: 8, bottom: 0 }}>
          ...
          <Line type="monotone" dataKey="income" name={`${t.incomeLabel} · ${t.trendLabel}`} stroke="#6f9aae" strokeWidth={2} strokeDasharray="4 3" dot={false} activeDot={{ r: 3 }} isAnimationActive={false} legendType="none" />
        </ComposedChart>
      </ResponsiveContainer>
      <div className="fc-analytics-legend">
        ...
        <div className="fc-analytics-legend-item"><i className="fc-analytics-legend-line" style={{ background: '#6f9aae' }} /><span>{t.incomeLabel} {t.trendLabel}</span></div>
      </div>
...
function MetricBar({ label, value, invert }) {
  ...
  const gradient = bad ? 'linear-gradient(90deg, #b0584f, #8a5a4a)' : 'linear-gradient(90deg, #9c7a45, #4f8a8b)';
  return (
...
.fc-app[data-theme="dark"], .fc-authwrap[data-theme="dark"], .fc-wizard[data-theme="dark"] {
  ...
  /* Cards go flat black with a gold hairline border in dark mode — premium/elegant look.
     Upcoming keeps the plain --fc-border-strong so it still reads as visually distinct. */
  --fc-border-card: rgba(156, 122, 69, 0.45);
}
...
.fc-btn-primary { display:flex; align-items:center; gap:6px; background: linear-gradient(135deg, #2b2118, #3d2f22); color: var(--fc-gold-bright, #c2a066); border: 1px solid rgba(156,122,69,0.55); padding: 9px 14px; border-radius: 8px; font-size: 13px; font-weight:700; cursor:pointer; box-shadow: 0 2px 8px rgba(0,0,0,0.2); }
