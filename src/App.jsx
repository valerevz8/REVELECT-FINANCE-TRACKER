...
const CAT_COLORS = {
  ...
  utilities: '#6FA8DC',   // soft steel blue
  health: '#8FC08A',      // soft green
  gym: '#5FB3A6',         // soft teal
  shopping: '#EDA05F',    // soft orange
  vacation: '#F2B872',    // soft amber
  education: '#9FB4D8',   // soft periwinkle
  family: '#D89AA8',      // soft rose
  pets: '#B7A6D9',        // soft lavender
  subscription: '#8FA6A0',// soft sage
  work: '#B0A17E',        // soft khaki
  other_expense: '#ADA192',// soft taupe
  salary: '#8FC08A', freelance: '#7FAAC9', trading: '#5FB3A6', content: '#A79BD1', other_income: '#ADA192',
  gold: '#D4AF6A', deposito: '#7FAAC9', reksadana: '#8FA6A0', other_investment: '#ADA192',
};
...
const CAT_ICONS = {
  ...
  gold: Coins, deposito: PiggyBank, reksadana: BarChart3, other_investment: MoreHorizontal,
};
      ...
      {open && (
        <div className="fc-modal-backdrop" onClick={() => setOpen(false)}>
          <div className="fc-modal" onClick={(e) => e.stopPropagation()} style={{ textAlign: 'center' }}>
            <div className="fc-modal-header"><span className="fc-revi-mark" style={{ margin: '0 auto' }}>R</span><button type="button" className="fc-icon-btn" onClick={() => setOpen(false)}><X size={16} /></button></div>
            <div className="fc-field-note" style={{ padding: '10px 0 4px' }}>{t.reviComingSoon}</div>
          </div>
        </div>
      )}
    </>
    ...
    <div className="fc-card fc-analytics-card">
      ...
      <ResponsiveContainer width="100%" height={240}>
        <ComposedChart data={data} margin={{ left: 0, right: 8, top: 8, bottom: 0 }}>
          ...
          <Line type="monotone" dataKey="net" name={t.netLabel} stroke="var(--fc-gold-bright, #c9a977)" strokeWidth={1.5} dot={false} isAnimationActive={false} />
        </ComposedChart>
      </ResponsiveContainer>
...
.fc-app[data-theme="dark"], .fc-authwrap[data-theme="dark"], .fc-wizard[data-theme="dark"] {
  ...
  --fc-text: #f0ece4; --fc-text-dim: #9b9186; --fc-gold-bright: #e0c396; --fc-border-strong: #4a4032;
}
.fc-app[data-theme="light"], .fc-authwrap[data-theme="light"], .fc-wizard[data-theme="light"] {
  ...
  --fc-text: #2b2418; --fc-text-dim: #78705f; --fc-gold-bright: #8a6a30; --fc-border-strong: #cbbd9c;
}
...
.fc-bottomnav-active { color: var(--fc-gold-bright, #c9a977); background: rgba(201,169,119,0.1); }
.fc-bottomnav-action { background: var(--fc-gold-bright, #c9a977); border: none; color: var(--fc-bg); width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; flex-shrink: 0; margin: 0 4px; box-shadow: 0 4px 14px rgba(201,169,119,0.35); transition: transform 0.2s ease; }
...
.fc-revi-mark { display: inline-flex; align-items: center; justify-content: center; width: 22px; height: 22px; border-radius: 50%; background: var(--fc-gold-bright, #c9a977); color: var(--fc-bg); font-weight: 800; font-size: 12px; font-family: 'Calibri','Segoe UI',sans-serif; flex-shrink: 0; }
...
.fc-analytics-legend { display:flex; gap: 18px; margin-top: 4px; padding-top: 10px; border-top: 1px solid var(--fc-border); }
...
.fc-split-final-row { display: flex; justify-content: space-between; align-items: center; margin-top: 8px; padding-top: 10px; border-top: 1px solid var(--fc-border-strong, var(--fc-border)); font-size: 15px; font-weight: 700; color: var(--fc-gold-bright, #c9a977); }
