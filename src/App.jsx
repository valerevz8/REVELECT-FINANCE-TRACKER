...
function Dashboard({ t, totals, health, totalDebtRemaining, lang, displayName, budgets, onEditBudget, investPlan, onEditInvestPlan, accounts, onAddAccount, onEditAccount, onDeleteAccount, recurringItems, debts, monthlyRows, onViewAnalytics }) {
  ...
  return (
    <div className="fc-dashboard">
            ...
            <div className="fc-spend-bars">
              {topSpendCats.map(([cat, val]) => (
                <div key={cat} className="fc-spend-bar-row">
                  ...
                  <div className="fc-spend-bar-track"><div className="fc-spend-bar-fill" style={{ width: `${maxCatValue ? (val / maxCatValue) * 100 : 0}%` }} /></div>
      ...
      <div className="fc-section-divider">{t.moreDetail}</div>
